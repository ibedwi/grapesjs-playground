// Reference: https://github.com/GrapesJS/react/blob/main/packages/grapesjs-react-app/src/examples/components/CustomLayerManager.tsx
...
export function SidebarLayerManager({
  root,
  ...
  // ========================================
  // #endregion | Drag n Drop Handler
  // ========================================

  return (
    <div
      className="h-full overflow-y-auto overflow-x-hidden text-sm text-left select-none relative px-3"
      style={wrapGridStyle}
